      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {steps.map((item) => (
          <article key={item.step} className="glass-panel relative overflow-hidden rounded-3xl p-6 transition duration-300 hover:-translate-y-1 hover:border-[color:var(--brand)]/35">
            ...
            <span className="relative mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full bg-[var(--brand)] text-base font-bold text-white shadow-[0_8px_20px_rgba(13,99,255,0.35)]">
              {item.step}
            </span>
