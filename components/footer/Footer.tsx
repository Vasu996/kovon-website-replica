...
const Footer = (): JSX.Element => {
  return (
    <footer id="contact" className="pt-8 pb-14">
        ...
        <div className="glass-panel rounded-[2rem] p-8 text-[var(--ink-soft)] md:p-10">
          <div className="mb-8 rounded-2xl border border-[var(--line)] bg-[var(--surface-3)] px-4 py-4 text-center sm:px-6">
            <p className="text-sm font-semibold leading-7 text-[var(--ink-soft)] sm:text-base">
              ...
              <a href="#home" className="ml-2 font-bold text-[var(--brand)]">
                Start now
              </a>
            </p>
          </div>
          <div className="grid gap-10 md:grid-cols-4">
            <div>
              ...
              <p className="max-w-xs text-sm leading-7 font-medium">
              ...
              <div className="flex gap-3">
                {socialLinks.map((item) => {
                  ...
                  return (
                    ...
                    className="glass-soft rounded-full p-2.5 text-[var(--ink-soft)] transition hover:-translate-y-0.5 hover:border-[color:var(--brand)] hover:text-[var(--brand)]"
                  >
                    <Icon fontSize="small" />
                  </a>
                  );
